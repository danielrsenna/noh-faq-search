                    ...
                    rx.popover.root(
                        ...
                        rx.popover.content( 
                            rx.cond(
                                ...
                                rx.flex(
                                    rx.button(
                                        rx.icon(tag="thumbs-up",size=15,stroke_width=2),
                                        variant="ghost",
                                        color_scheme="green",
                                        on_click=SearchState.send_positive_feedback,
                                    ),
                                    rx.button(
                                        rx.icon(tag="thumbs-down",size=15,stroke_width=2),
                                        variant="ghost", 
                                        color_scheme="red",
                                        on_click=SearchState.send_negative_feedback,
                                    ),
                                    align="center",
                                    justify="between",
                                    spacing="2",
